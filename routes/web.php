...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::get('/dashboard',[DashboardCntroller::class,'index'])->name('dashboard');
    ...
    Route::post('/sub-category/new',[SubCategoryController::class,'store'])->name('sub-category.store');
    ...
    Route::post('/brand/new',[BrandController::class,'store'])->name('brand.store');
    ...
    Route::post('/unit/new',[UnitController::class,'store'])->name('unit.store');
    ...
    Route::get('/admin/update-order/{id}',[AdminOrderController::class,'update'])->name('admin.update-order');
