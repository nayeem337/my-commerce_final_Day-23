...
@section('body')
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" align="center">Edit Product  Form </h4>
                    <hr/>
                    ...
                    <form class="form-horizontal p-t-20" action="{{route('product.update',['id'=>$product->id])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="unit_id">
                                    ...
                                    @foreach($units as $unit)
                                        <option value="{{$unit->id}}" {{$unit->id == $product->unit_id ? 'selected': ''}} >{{$brand->name}} >{{$unit->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="stock_amount" value="{{$product->stock_amount}}" placeholder="Product Stock Amount ">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="number" class="form-control" name="regular_price" value="{{$product->regular_price}}" id="" placeholder="Regular Price  ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea  class="form-control summernote" name="short_description" value="{{$product->short_description}}" id="exampleInputEmail3" placeholder="Product short Description"> </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea  class="form-control summernote" name="long_description" value="{{$product->long_description}}" id="exampleInputEmail3" placeholder="Product Long Description"> </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <label for="" class="me-3"><input type="radio" {{$product->status == 1 ? 'checked' : ''}} name="status" value="1"> Published</label>
                                <label for=""><input type="radio" name="status" {{$product->status == 2 ? 'checked' : ''}}  value="2"> unpblished</label>
                            </div>
                        </div>
